...
В заключении по работе с инструкцией git можно выделить следующее,что это удобный инструмент по работе с текстом и создания проектов.
Очень много преимуществ,который git в себя вмещает.